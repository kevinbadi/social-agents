  ...
  render(root, data, ctx) {
    ...
    if (data.source === 'template') {
      const hint = note('training-template',
        'Showing the repo’s template playbooks — onboarding installs a copy into social-agents/skills/ that the agent actually runs. Edits here change the templates for future installs.');
